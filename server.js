...
const hints = {
  ...
  10: "The audio is reversed Morse. Reverse it, then decode the dots and dashes.",
...
const stages = {
  ...
  10: {
    title: "Stage 10: The Backward Signal",
    body: `
      <p>This audio is a reversed signal. Reverse it, then decode the Morse.</p>
      <button class="btn" onclick="playReversedMorse()">Play Reversed Signal</button>
      <p class="subtle">If it feels backwards, you are on the right track.</p>
    `,
  },
  11: {
