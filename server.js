...
const hints = {
  ...
  10: "The voice is backwards. Reverse it.",
...
const stages = {
  ...
  10: {
    title: "Stage 10: The Backward Voice",
    body: `
      <p>Play the reversed voice and flip the message.</p>
      <button class="btn" onclick="playReversed()">Play Reversed Audio</button>
      <p class="subtle">If it sounds wrong, that is the point.</p>
    `,
  },
  11: {
